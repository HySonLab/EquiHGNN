...
from equihgnn.models.layers.equiformer.utils import cast_torch_tensor, l2norm, to_order
...
def rot_z(gamma):
    ...
    out = torch.stack((c, -s, z, s, c, z, z, z, o), dim=-1)
...
def rot_y(beta):
    ...
    out = torch.stack((c, z, s, z, o, z, -s, z, c), dim=-1)
