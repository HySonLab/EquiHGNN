...
from equihgnn.models.layers.se3_transformer.irr_repr import (
    irr_repr,
    spherical_harmonics,
)
from equihgnn.models.layers.se3_transformer.spherical_harmonics import (
...
def get_spherical_from_cartesian(cartesian, divide_radius_by=1.0):
    ...
    # :param theta: the colatitude / polar angle, ranging from 0(North Pole, (X, Y, Z) = (0, 0, 1)) to pi(South Pole,
    # (X, Y, Z) = (0, 0, -1)).
